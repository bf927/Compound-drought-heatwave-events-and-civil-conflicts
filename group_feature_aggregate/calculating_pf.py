...
group_region_file = 'D:\\Drought_and_heat_wave_coupling\\data\\mask\\pf\\raster_filter\\'
group_mask_path_list = glob.glob(group_region_file + '*.tif')
image_file = 'D:\\Drought_and_heat_wave_coupling\\data\\deaths_pf_per_100,000\\'
...
saveExcel(array, 'D:\\Drought_and_heat_wave_coupling\\data\\deaths_pf_per_100,000\\pf_sum.xlsx')